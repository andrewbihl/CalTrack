...
public extension CLLocationCoordinate2D {
    ...
    public static func stopCoordinates(id: Int) -> CLLocationCoordinate2D? {
        // Slow but who cares
        if let index = stopIDs.index(of: id){
            return CLLocationCoordinate2DMake(stopLatitudes[index], stopLongitudes[index])
        }
        return nil
    }
